    ...
    def test_installed_template_matches_packaged_defaults(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch("atelier.paths.atelier_data_dir", return_value=data_dir):
                packaged = templates.agents_template()
                ...
                assert templates.installed_template_modified("AGENTS.md") is False
    ...
    def test_installed_template_differs_from_packaged_defaults(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch("atelier.paths.atelier_data_dir", return_value=data_dir):
                ...
                assert templates.installed_template_modified("AGENTS.md") is True
