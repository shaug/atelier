...
class FakeNextChangesetService:
    def __init__(
        ...
        *,
        ...
        refined_eligibility_by_id: dict[str, tuple[bool, str | None]] | None = None,
    ) -> None:
        ...
        self._refined_eligibility_by_id = refined_eligibility_by_id or {}
    ...
    def refined_planning_claim_eligible(
        ...
        if not isinstance(issue_id, str):
            return True, None
        return self._refined_eligibility_by_id.get(issue_id, (True, None))
...
def test_next_changeset_service_skips_unapproved_refined_changeset() -> None:
    ...
    service = FakeNextChangesetService(
        ...
        refined_eligibility_by_id={"at-epic.1": (False, "missing refined approval")},
    )
