...
## [0.8.0](https://github.com/shaug/atelier/compare/v0.7.0...v0.8.0) (2026-03-01)
...
* **config:** replace branch.pr with explicit branch.pr_mode ([4d7f0f9](https://github.com/shaug/atelier/commit/4d7f0f915328501a9b6dac97ea41fd96d5f774d5)), closes [#138](https://github.com/shaug/atelier/issues/138)
...
* **repo:** enforce Ruff pre-commit checks in local hooks ([012f4c3](https://github.com/shaug/atelier/commit/012f4c3cd104c66193cef076547cd866bc70e431)), closes [#143](https://github.com/shaug/atelier/issues/143)
...
* **beads:** default skill bd invocations to direct mode ([ff14056](https://github.com/shaug/atelier/commit/ff14056ab95729669946a6f74621d290edf46c16)), closes [#134](https://github.com/shaug/atelier/issues/134)
...
* **beads:** honor explicit daemon config in skill scripts ([ec84b69](https://github.com/shaug/atelier/commit/ec84b694b5b4c000e90c653f78b8b21a7d7a2586)), closes [#134](https://github.com/shaug/atelier/issues/134)
...
* **config:** skip PR strategy prompt when pr mode is none ([95817f8](https://github.com/shaug/atelier/commit/95817f8f457cc1ff0f50dcc14b9f4a3b2769187b)), closes [#149](https://github.com/shaug/atelier/issues/149)
...
* **lint:** align pre-commit, local lint, and CI gates ([8b740c5](https://github.com/shaug/atelier/commit/8b740c5b49561a1d7680454a12bfa2d9b14ec92e)), closes [#147](https://github.com/shaug/atelier/issues/147)
...
* **planner:** default captured changesets to draft state ([5cdb3a5](https://github.com/shaug/atelier/commit/5cdb3a5af7e27ae04fc6f5cc14d12f8421ddfc2e))
...
* **pr-gate:** remove repo-specific lint gate references ([43a77ff](https://github.com/shaug/atelier/commit/43a77ff19a581d6624fe0a96f8d8ae989dc13692))
...
* **worker:** disallow root-branch PR bases ([1951566](https://github.com/shaug/atelier/commit/19515668d954a1439bb50f43ad0c5575078f2a29)), closes [#145](https://github.com/shaug/atelier/issues/145)
...
* **worker:** enforce role invariants on worker identity and claims ([9484ebd](https://github.com/shaug/atelier/commit/9484ebdbd1ab1d740363ac2c75b5b5c8b7559f64)), closes [#162](https://github.com/shaug/atelier/issues/162)
...
* **worker:** harden draft transport for commit issue and PR bodies ([bd1e70b](https://github.com/shaug/atelier/commit/bd1e70b8ad620d3d57ee93a5e63aa9ca3cb216a6)), closes [#133](https://github.com/shaug/atelier/issues/133)
...
* **worker:** normalize parent-child dependency variants ([2e89fe0](https://github.com/shaug/atelier/commit/2e89fe0e094578104c8cc3ce4e32cec773906dd2))
* **worker:** normalize standalone changeset epic identity ([09fbeb1](https://github.com/shaug/atelier/commit/09fbeb13ef8ee3104e9192c39ec0a618569da604))
...
* **worker:** prevent duplicate PR creation on finalize reruns ([fcead91](https://github.com/shaug/atelier/commit/fcead91a2d929374d53fb1bd31c732389aa43441)), closes [#168](https://github.com/shaug/atelier/issues/168)
...
* **worker:** prioritize explicit epic feedback startup ([9bc0374](https://github.com/shaug/atelier/commit/9bc03748c6935dc7f0ff18b98ad80989ef3f90c0)), closes [#141](https://github.com/shaug/atelier/issues/141)
...
* **worker:** remove PR-finalize lint gate enforcement ([1130d34](https://github.com/shaug/atelier/commit/1130d34b84bb71372a6eeee0f2ec8f2d8f7ecb2a))
...
* **worker:** resolve PR lint gate command from AGENTS policy ([4d870d2](https://github.com/shaug/atelier/commit/4d870d24cad67819ced83ac73c9d29b7395441a1))
...
* **worker:** satisfy pr gate mapping type ([0f1da25](https://github.com/shaug/atelier/commit/0f1da2540630cdf161b750ab60e456c4e0a4d65b))
...
* **worker:** surface planner-owned review-feedback blockers ([a487602](https://github.com/shaug/atelier/commit/a4876021f9aef205e64d63ac18baea501507655f)), closes [#163](https://github.com/shaug/atelier/issues/163)
...
* **worker:** type branch pr mode as BranchPrMode in recovery wrapper ([60fb0ea](https://github.com/shaug/atelier/commit/60fb0ea39c2265d2b2589e3cf6bbeb187728a3ba))
